...
# TODO: swap scene per stats.scene_tier when BacteriaTier2.tscn / BacteriaTier3.tscn are ready
...
func _start_defend_phase() -> void:
	...
	var stats := BacteriaStats.for_filth(StainSystem.get_filth_percent())
